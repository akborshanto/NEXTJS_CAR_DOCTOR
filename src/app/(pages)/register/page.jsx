...
const Register = () => {
  ...
  return (
    ...
    <div className="hero-content   flex-col-reverse lg:flex-row lg:justify-between gap-8">
      ...
      <h1 className="text-3xl lg:text-3xl font-bold  text-red-500 text-center  animate-pulse my-5">Register now!</h1>
        <form className="card-body" onSubmit={handleSubmit}>
          <div className="form-control">
            <label className="label">
              <span className="label-text">Name</span>
            </label>
            <input name='name' type="text" placeholder="your name" className="input hover:border-red-500 text-black bg-white " required />
          </div>
          <div className="form-control">
            <label className="label">
...
<h3 className='text-center font-bold text-xl my-4'>           Already  Have an account? <span className='font-bold text-red-500'> <Link href='/login'>Sign In</Link></span>
